...
const HomePage = () => {
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center bg-gray-900 text-gray-100 px-4 text-center ">
      ...
      {/* Main Heading */}
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-wide text-blue-400 mb-3">
        KeyStone Bank
      </h1>

      {/* Highlight Line */}
      <p className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-300 mb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-4xl">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-4 hover:border-blue-500 transition">
