...
const Gt = () => {
  const data={
      ...
      "tailwindColor": "bg-sky-900",
      "caption": "Titans of Ahmedabad",
      "titlesWon": 1,
      "shortDescription": "Newer franchise (debut 2022) that won the IPL in its inaugural season; plays at the world's largest cricket stadium."
    }
