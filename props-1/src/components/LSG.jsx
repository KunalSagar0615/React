...
import lsgimage from '../assets/lsg.jpeg'
...
const LSG = () => {
  const data={
      ...
      "tailwindColor": "bg-indigo-600",
      "caption": "Super Giants of Lucknow",
      "titlesWon": 0,
      "shortDescription": "A relatively recent expansion franchise (debut 2022) with competitive squads and growing fan support."
    }
  return (
